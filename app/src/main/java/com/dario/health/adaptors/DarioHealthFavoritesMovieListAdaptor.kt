...
import com.dario.health.databinding.DarioHealthFavoritesMovieListAdaptorActivityBinding


class DarioHealthFavoritesMovieListAdaptor(itemViewModels: ArrayList<MovieListEntity>) :
    RecyclerView.Adapter<DarioHealthFavoritesMovieListAdaptor.BindableViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BindableViewHolder {
        val binding: DarioHealthFavoritesMovieListAdaptorActivityBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.dario_health_favorites_movie_list_adaptor_activity,
            parent,
            false
        )
    ...
    inner class BindableViewHolder(private val binding: DarioHealthFavoritesMovieListAdaptorActivityBinding) :
